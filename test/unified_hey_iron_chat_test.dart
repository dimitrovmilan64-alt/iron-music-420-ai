...
void main() {
  ...
  test('living core has depth and distinct interaction states', () {
    ...
    expect(widgets, contains('Image.asset'));
    expect(widgets, contains('FilterQuality.high'));
    expect(widgets, contains('ClipOval'));
    expect(widgets, contains('class _LivingLeafVeinPainter'));
    expect(widgets, contains('leafPulse'));
    expect(widgets, isNot(contains('class _IronCoreLeafPainter')));
    expect(widgets, isNot(contains('_ironCannabisLeafSilhouette')));
    expect(widgets, isNot(contains('_ironCannabisLeaflet')));
    expect(widgets, isNot(contains('_ironLeafTipTargets')));
    expect(widgets, isNot(contains('_ironCoreLeafScale')));
    expect(widgets, isNot(contains('PathOperation.union')));
    expect(widgets, isNot(contains('rotateY(leafTurn)')));
