...
Използвай силни вътрешни и многосрични рими, естествен български език, ясен flow и запомнящ се припев.
Не копирай известна песен или конкретен изпълнител.
...
Запази историята, смисъла и личния тон. Подобри flow-а, вътрешните и многосричните рими, ударните окончания и естествения български език.
Не променяй силните редове без причина. Не добавяй обяснения. Не използвай кръгли скоби с указания.
...
Да е лесен за запомняне, ритмичен и годен за повторение. Използвай естествен български език и силни рими.
Стил: $_style. Настроение: $_mood. Темпо: $_bpm BPM.
...
Силен flow, вътрешни и многосрични рими, ясни punchlines, без празни пълнежни редове.
Стил: $_style. Настроение: $_mood. Темпо: $_bpm BPM.
